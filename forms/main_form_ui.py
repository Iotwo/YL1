...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.catSelection_cmbBox = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        self.catSelection_cmbBox.setMinimumSize(QtCore.QSize(180, 30))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        self.catSelection_cmbBox.setFont(font)
        self.catSelection_cmbBox.setObjectName("catSelection_cmbBox")
        self.categories_vLayout.addWidget(self.catSelection_cmbBox)
        self.opSelection_list = QtWidgets.QListWidget(self.horizontalLayoutWidget)
        self.opSelection_list.setMinimumSize(QtCore.QSize(180, 120))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        self.opSelection_list.setFont(font)
        self.opSelection_list.setObjectName("opSelection_list")
        self.categories_vLayout.addWidget(self.opSelection_list)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal6_btn, 0, 0, 1, 1)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal5_btn, 0, 1, 1, 1)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal1_btn, 4, 1, 1, 1)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal4_btn, 2, 0, 1, 1)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal3_btn, 2, 1, 1, 1)
        ...
        self.predefinedAmt_gLayout.addWidget(self.defVal2_btn, 4, 0, 1, 1)
        ...
        self.main_menu_bar.setGeometry(QtCore.QRect(0, 0, 910, 30))
        ...
        self.main_menu_tables_btn.setGeometry(QtCore.QRect(267, 126, 240, 94))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.menu_export_btn = QtWidgets.QAction(MainForm)
        self.menu_export_btn.setObjectName("menu_export_btn")
        ...
        self.menu_actions.addAction(self.menu_export_btn)
    ...
    def retranslateUi(self, MainForm):
        ...
        self.defVal6_btn.setText(_translate("MainForm", "150"))
        self.defVal5_btn.setText(_translate("MainForm", "300"))
        self.defVal1_btn.setText(_translate("MainForm", "5000"))
        self.defVal4_btn.setText(_translate("MainForm", "500"))
        self.defVal3_btn.setText(_translate("MainForm", "1000"))
        self.defVal2_btn.setText(_translate("MainForm", "1500"))
...
"и очистить"))
        ...
        self.menu_export_btn.setText(_translate("MainForm", "Экспорт данных"))
